...
$board.append(htmlString);$boardInputs=$board.find("input");$boardInputCandidates=$board.find(".candidates");var HTMLSnippet=['<a href="https://mczak.com/code/sudoku/" target="_blank">Sudoku HTML</a>'].join('');$board.append(HTMLSnippet);};var renderBoardCell=function(boardCell,id){var val=(boardCell.val===null)?"":boardCell.val;var candidates=boardCell.candidates||[];var candidatesString=buildCandidatesString(candidates);var maxlength=(boardSize<10)?" maxlength='1'":"";return "<div class='sudoku-board-cell'>"+
